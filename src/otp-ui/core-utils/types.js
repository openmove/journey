...
export const modeSelectorOptionsType = PropTypes.shape({
  primary: PropTypes.oneOfType([modeOptionType, undefined]),
  secondary: PropTypes.oneOfType([modeOptionType, [], undefined]),
  tertiary: PropTypes.oneOfType([modeOptionType, [], undefined])
});
