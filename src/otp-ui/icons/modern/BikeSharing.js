...
const BikeSharing = ({ title, width = 22, height = 17, iconColor = '#000', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 22.434 17">
      ...
      <g id="Group_139" data-name="Group 139" transform="translate(21.281 12.06)">
        <g id="noun_Time_2415472" transform="translate(-5.599 -7.608)">
          <g id="Layer_2" data-name="Layer 2" transform="translate(0 0)">
            <path id="Path_78" data-name="Path 78" d="M7.72,14.44a6.72,6.72,0,1,1,6.72-6.72A6.72,6.72,0,0,1,7.72,14.44ZM7.72,1.9A5.824,5.824,0,1,0,13.544,7.72,5.824,5.824,0,0,0,7.72,1.9Z" transform="translate(-1 -1)" fill={iconColor}/>
            <path id="Path_79" data-name="Path 79" d="M10.955,12.075h0a.448.448,0,0,1,.1-.627l1.662-1.2v-3.8A.448.448,0,0,1,13.168,6h0a.448.448,0,0,1,.448.448v4.26l-2.034,1.469a.448.448,0,0,1-.627-.1Z" transform="translate(-6.449 -3.76)" fill={iconColor}/>
          </g>
        </g>
